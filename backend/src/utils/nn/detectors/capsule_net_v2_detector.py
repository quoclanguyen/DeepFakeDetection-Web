...
from utils.nn.metrics.base_metrics_class import calculate_metrics_for_train

from .base_detector import AbstractDetector
from utils.nn.detectors import DETECTOR
from utils.nn.networks import BACKBONE
from utils.nn.loss import LOSSFUNC

import torchvision.models as models

@DETECTOR.register_module(module_name='capsule_net_v2')
class CapsuleNetV2Detector(AbstractDetector):
